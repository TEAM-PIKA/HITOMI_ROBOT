...
PM_START_TEXT = """
Hi {}, My name is {} !
I am a powerful telegram group management bot with anime fun!
Add me to your groups for spam free running.
Hit /help for seeing a list of available commands.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_animation(
                ...
                reply_markup=InlineKeyboardMarkup(
                    ...
                    [
                        InlineKeyboardButton(
                            text="🔹️Support Chat🔹️",
                            url="https://t.me/hitomi_Support"),
                        InlineKeyboardButton(
                            text="Help❕",
                            url="https://t.me/hitomi_robot?start=help")
                    ]]))
...
def gethelp(update, context):
    ...
    if query.data == "gethelp_pr":
        ...
        query.message.edit_text(
            text="I have sent you the requested information in private chat.", 
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
